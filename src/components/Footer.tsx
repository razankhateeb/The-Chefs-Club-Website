...
export function Footer() {
    return <div className="footer text-white pb-5 pt-5">
        <Container>
            <Row >
                ...
                <div className="col-lg-3 col-md-6 footer-links d-flex">
                    ...
                    <div>
                        <h4>Reservations</h4>
                        <p>
                            <strong>Phone:</strong> +962 6 1234567<br />
                            <strong>Email:</strong> info@thechefsclub.com<br />
                        </p>
                    </div>
                </div>
                ...
                <Container className="text-center mt-3">
                    <div className="copyright">
                        &copy; Copyright <strong><span>The Chef Club</span></strong>. All Rights Reserved
                    </div>
                    <div className="credits">
                        Designed by <strong>Razan</strong>
                    </div>
                </Container>
            </Row>
        </Container>
